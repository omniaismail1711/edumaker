...
import { Menu, X, Search, Briefcase, User, LayoutDashboard, GraduationCap, BookOpen, Sun, Moon, Globe, Award, FolderKanban } from "lucide-react";
...
export default function Navbar() {
  ...
  const navItems = [
    ...
    { label: lang === "ar" ? "المشاريع" : "Projects", path: "/projects", icon: FolderKanban },
